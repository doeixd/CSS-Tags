...
<LiveExample title="Connected fields that adapt">
  <layout-stack container-query gap="var(--space-lg)">
    ...
    <form class="form-field" role="search">
      ...
      <search-input>
        <svg data-search-icon aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
