...
Cards follow the shared [Browser Support](/CSS-Tags/guides/browser-support/)
baseline. Their narrow, stacked composition is the default; the horizontal
arrangement is a container-query enhancement when enough space is available.
