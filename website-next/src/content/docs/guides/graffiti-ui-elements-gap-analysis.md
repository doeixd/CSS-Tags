---
title: Graffiti UI Elements Gap Analysis
description: A component-by-component audit of CSS Tags against Graffiti UI, with a prioritized roadmap for missing primitives.
---
...
through `index.css`. See [Element patterns](../../components/element-patterns/)
