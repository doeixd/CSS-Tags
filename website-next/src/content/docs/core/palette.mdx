...
The palette uses the library's core browser baseline because the semantic theme
depends on relative OKLCH colors. See [Browser Support](/CSS-Tags/guides/browser-support/)
for exact versions and fallback guidance.
