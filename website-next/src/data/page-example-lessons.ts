...
export const primaryExamples: Record<string, PageExampleSeed> = {
    ...
    "components/table": {
        title: "Headers describe both axes",
        description: "Column scopes, row scopes, and a caption preserve the relationships that make tabular data useful.",
        preview: `<data-table tabindex="0" aria-label="Scrollable plan comparison"><table data-table><caption>Plan comparison</caption><thead><tr><th scope="col">Plan</th><th scope="col">Projects</th><th scope="col">Members</th></tr></thead><tbody><tr><th scope="row">Starter</th><td>3</td><td>5</td></tr><tr><th scope="row">Team</th><td>Unlimited</td><td>25</td></tr></tbody></table></data-table>`,
        code: `<data-table tabindex="0" aria-label="Scrollable plan comparison">\n  <table data-table>\n    <caption>Plan comparison</caption>\n    <thead>\n      <tr><th scope="col">Plan</th><th scope="col">Projects</th></tr>\n    </thead>\n    <tbody>\n      <tr><th scope="row">Starter</th><td>3</td></tr>\n      <tr><th scope="row">Team</th><td>Unlimited</td></tr>\n    </tbody>\n  </table>\n</data-table>`,
    },
    "components/tabs": {
...
export const supplementalExamples: Record<string, PageExampleLesson[]> = {
    ...
    "components/table": [{
        title: "Variants change emphasis, not structure",
        description: "Striping, hover, thick borders, and borderless presentation all retain the same native table model.",
        preview: `<data-table tabindex="0"><table data-table class="table-striped table-hover"><thead><tr><th scope="col">Token</th><th scope="col">Value</th></tr></thead><tbody><tr><th scope="row">Radius</th><td>0.75rem</td></tr><tr><th scope="row">Spacing</th><td>1rem</td></tr><tr><th scope="row">Measure</th><td>65ch</td></tr></tbody></table></data-table>`,
        code: `<table data-table class="table-striped table-hover">\n  <thead>...</thead>\n  <tbody>...</tbody>\n</table>\n\n<table data-table class="table-bordered">...</table>\n<table data-table class="table-borderless">...</table>`,
    }],
    "components/tabs": [{
...
const advancedSupplementalExamples: Record<string, PageExampleLesson[]> = {
    ...
    "components/table": [{
        title: "A borderless table still needs responsive focus",
        description: "The visual variant removes chrome, not semantics; keep caption, scopes, and a keyboard-accessible scroll host.",
        preview: `<data-table class="table-borderless" tabindex="0" aria-label="Recent invoices"><table data-table><caption>Recent invoices</caption><thead><tr><th scope="col">Invoice</th><th scope="col">Status</th><th scope="col">Total</th></tr></thead><tbody><tr><th scope="row">INV-1042</th><td><badge status="success">Paid</badge></td><td>$240</td></tr><tr><th scope="row">INV-1043</th><td><badge status="warning">Due</badge></td><td>$180</td></tr></tbody></table></data-table>`,
        code: `<data-table class="table-borderless" tabindex="0" aria-label="Recent invoices">\n  <table data-table>\n    <caption>Recent invoices</caption>\n    <thead><tr><th scope="col">Invoice</th><th scope="col">Status</th></tr></thead>\n    <tbody><tr><th scope="row">INV-1042</th><td><badge status="success">Paid</badge></td></tr></tbody>\n  </table>\n</data-table>`,
    }],
    "components/tabs": [{
