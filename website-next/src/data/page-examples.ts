...
const examples: Record<string, PageExampleDefinition> = {
    ...
    "components/tooltips": {
        ...
        preview: `<layout-cluster justify="center" style="padding-block:2rem"><button type="button" data-tooltip-host aria-describedby="billing-tip">Billing info<tooltip id="billing-tip" role="tooltip" position="top"><strong>Next invoice</strong><br><small>Due on August 1</small></tooltip></button></layout-cluster>`,
        code: `<button type="button" data-tooltip-host aria-describedby="billing-tip">\n  Billing info\n  <tooltip id="billing-tip" role="tooltip" position="top">\n    <strong>Next invoice</strong>\n    <small>Due on August 1</small>\n  </tooltip>\n</button>`,
    },
