...
<LiveExample title="Scrollable navigation reel" description="The children stay intrinsic-width; scroll horizontally when the row is too wide.">
  <layout-reel gap="var(--space-sm)" no-scrollbar aria-label="Project sections">
    <a class="example-panel" style="min-inline-size: 12rem;" href="#overview">Overview</a>
    <a class="example-panel" style="min-inline-size: 12rem;" href="#activity">Activity</a>
    <a class="example-panel" style="min-inline-size: 12rem;" href="#integrations">Integrations</a>
    <a class="example-panel" style="min-inline-size: 12rem;" href="#permissions">Permissions</a>
    <a class="example-panel" style="min-inline-size: 12rem;" href="#audit-log">Audit log</a>
  </layout-reel>
</LiveExample>
