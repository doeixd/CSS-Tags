...
The shipped card selectors currently support the custom-element form (`card`, `card-body`, and related tags). Class and `data-*` host aliases are not currently defined for this component.
