...
### UI Components
Pre-built styling contracts include `<card>`, native `<button>`,
`<alert-message>`, `<badge>`, `<dialog data-modal>`, `<tooltip>`,
`<carousel>`, and their documented native, data, or class alternatives.
