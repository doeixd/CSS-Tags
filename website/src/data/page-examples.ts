...
const examples: Record<string, PageExampleDefinition> = {
    ...
    "components/carousel": {
        ...
        preview: `<carousel data-doc-carousel loop radius="var(--radius-lg)"><div class="carousel-slides"><carousel-item><div class="example-slide">One</div></carousel-item><carousel-item><div class="example-slide">Two</div></carousel-item><carousel-item><div class="example-slide">Three</div></carousel-item></div><carousel-trigger direction="prev" role="button" tabindex="0" aria-label="Previous slide">&#8249;</carousel-trigger><carousel-trigger direction="next" role="button" tabindex="0" aria-label="Next slide">&#8250;</carousel-trigger></carousel>`,
        code: `<carousel loop radius="var(--radius-lg)">\n  <div class="carousel-slides">\n    <carousel-item>Slide one</carousel-item>\n    <carousel-item>Slide two</carousel-item>\n    <carousel-item>Slide three</carousel-item>\n  </div>\n  <carousel-trigger direction="prev">&#8249;</carousel-trigger>\n  <carousel-trigger direction="next">&#8250;</carousel-trigger>\n</carousel>\n<script type="module" src="/carousel.js"><\/script>`,
    },
    ...
    "js/carousel": {
        ...
        preview: `<carousel data-doc-carousel loop><div class="carousel-slides"><carousel-item><div class="example-slide">Dashboard</div></carousel-item><carousel-item><div class="example-slide">Reports</div></carousel-item><carousel-item><div class="example-slide">Settings</div></carousel-item></div><carousel-trigger direction="prev" role="button" tabindex="0" aria-label="Previous slide">&#8249;</carousel-trigger><carousel-trigger direction="next" role="button" tabindex="0" aria-label="Next slide">&#8250;</carousel-trigger></carousel>`,
    ...
    "js/view-transition": {
        ...
        preview: `<div data-doc-view-transition><layout-cluster><button type="button" data-doc-page="summary">Summary</button><button type="button" data-doc-page="activity">Activity</button></layout-cluster><view-page id="summary" active><div class="example-panel"><h3>Summary</h3><p class="example-muted">12 open tasks and 3 completed today.</p></div></view-page><view-page id="activity"><div class="example-panel"><h3>Activity</h3><p class="example-muted">The latest changes appear in this view.</p></div></view-page></div>`,
        code: `<nav-trigger to="summary">Summary</nav-trigger>\n<nav-trigger to="activity">Activity</nav-trigger>\n\n<view-page id="summary" active>...</view-page>\n<view-page id="activity">...</view-page>\n\n<script type="module" src="/view-transition.js"><\/script>`,
    },
